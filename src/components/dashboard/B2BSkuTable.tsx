...
import { Search, ArrowUpDown, Download, Building2 } from 'lucide-react';
...
export function B2BSkuTable({ data }: { data: SkuRow[] }) {
  ...
  const handleExport = () => {
    downloadCsv('b2b-sku', ['SKU', 'Prodotto', 'Pezzi Venduti', 'Ordine Raccolto', 'Ordine Consegnato'],
    ...
    <div className="chart-container">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-4">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-semibold">Dettaglio B2B per SKU</h3>
          <span className="text-[10px] px-1.5 py-0.5 rounded-full bg-amber-500/10 text-amber-400 font-medium">B2B</span>
        </div>
        <div className="flex items-center gap-2">
