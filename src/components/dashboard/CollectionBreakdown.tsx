...
function B2CCollectionTable({ orders }: { orders: Order[] }) {
  ...
  const handleExport = () => {
    downloadCsv('collection-b2c', ['Collection', 'Pezzi', 'Net Sales'],
    ...
    <div className="chart-container">
      ...
      <div className="overflow-x-auto scrollbar-custom">
        <table className="data-table">
          <thead><tr><th>Collection</th><th className="text-right">Pezzi</th><th className="text-right">Net Sales</th></tr></thead>
          <tbody>
          ...
          {data.length > 0 && (<tfoot><tr className="border-t-2 border-border font-semibold text-xs"><td>Totale</td><td className="text-right font-mono">{data.reduce((s, r) => s + r.qtySold, 0)}</td><td className="text-right font-mono">{fmt(data.reduce((s, r) => s + r.netSales, 0))}</td></tr></tfoot>)}
        </table>
      </div>
    </div>
  );
...
function B2BCollectionTable({ orders }: { orders: Order[] }) {
  ...
  const handleExport = () => {
    downloadCsv('collection-b2b', ['Collection', 'Pezzi', 'Price Somma'],
  ...
  return (
    <div className="chart-container">
      ...
      <div className="overflow-x-auto scrollbar-custom">
        <table className="data-table">
          <thead><tr><th>Collection</th><th className="text-right">Pezzi</th><th className="text-right">Price Somma</th></tr></thead>
          <tbody>
          ...
          {data.length > 0 && (<tfoot><tr className="border-t-2 border-border font-semibold text-xs"><td>Totale</td><td className="text-right font-mono">{data.reduce((s, r) => s + r.qtySold, 0)}</td><td className="text-right font-mono">{fmt(data.reduce((s, r) => s + r.priceSomma, 0))}</td></tr></tfoot>)}
        </table>
      </div>
    </div>
  );
...
function CombinedCollectionTable({ orders }: { orders: Order[] }) {
  ...
  const handleExport = () => {
    downloadCsv('collection-combined', ['Collection', 'Pezzi', 'B2C', 'B2B', 'Totale'],
  ...
  return (
    <div className="chart-container">
      ...
      <div className="overflow-x-auto scrollbar-custom">
        <table className="data-table">
          <thead><tr><th>Collection</th><th className="text-right">Pezzi</th><th className="text-right">B2C</th><th className="text-right">B2B</th><th className="text-right">Totale</th></tr></thead>
          <tbody>
